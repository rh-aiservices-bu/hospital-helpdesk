...
----
oc apply -n <your-project-name> -f https://github.com/rh-aiservices-bu/hospital-heldesk/raw/main/setup/setup-s3-job.yaml
----
====
...
+
image::1-setup/ds-project-connections.png[Connections for Fraud Detection]
